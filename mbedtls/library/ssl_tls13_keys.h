...
#define MBEDTLS_SSL_TLS1_3_LBL_LEN(LABEL) sizeof(mbedtls_ssl_tls13_labels.LABEL)

#define MBEDTLS_SSL_TLS1_3_LBL_WITH_LEN(LABEL) mbedtls_ssl_tls13_labels.LABEL, MBEDTLS_SSL_TLS1_3_LBL_LEN(LABEL)
...
#define MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_CONTEXT_LEN PSA_HASH_MAX_SIZE
...
#define MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_EXPANSION_LEN (255 * MBEDTLS_TLS1_3_MD_MAX_SIZE)

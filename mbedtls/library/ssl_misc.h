...
#if defined(MBEDTLS_ECP_RESTARTABLE) && defined(MBEDTLS_SSL_CLI_C) && defined(MBEDTLS_SSL_PROTO_TLS1_2) && \
 ...
 */
#define MBEDTLS_SSL_CONTEXT_FLAGS_KEEP_AT_SESSION (MBEDTLS_SSL_CONTEXT_FLAG_HOSTNAME_SET)
...
#define MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED                                              \
    (MBEDTLS_SSL_EXT_MASK(SUPPORTED_POINT_FORMATS) | MBEDTLS_SSL_EXT_MASK(ENCRYPT_THEN_MAC) | \
     MBEDTLS_SSL_EXT_MASK(EXTENDED_MASTER_SECRET) | MBEDTLS_SSL_EXT_MASK(SESSION_TICKET) |    \
     MBEDTLS_SSL_EXT_MASK(TRUNCATED_HMAC) | MBEDTLS_SSL_EXT_MASK(UNRECOGNIZED))

/* RFC 8446 section 4.2. Allowed extensions for ClientHello */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CH                                                                         \
    (MBEDTLS_SSL_EXT_MASK(SERVERNAME) | MBEDTLS_SSL_EXT_MASK(MAX_FRAGMENT_LENGTH) |                                   \
     MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST) | MBEDTLS_SSL_EXT_MASK(SUPPORTED_GROUPS) | MBEDTLS_SSL_EXT_MASK(SIG_ALG) |  \
     MBEDTLS_SSL_EXT_MASK(USE_SRTP) | MBEDTLS_SSL_EXT_MASK(HEARTBEAT) | MBEDTLS_SSL_EXT_MASK(ALPN) |                  \
     MBEDTLS_SSL_EXT_MASK(SCT) | MBEDTLS_SSL_EXT_MASK(CLI_CERT_TYPE) | MBEDTLS_SSL_EXT_MASK(SERV_CERT_TYPE) |         \
     MBEDTLS_SSL_EXT_MASK(PADDING) | MBEDTLS_SSL_EXT_MASK(KEY_SHARE) | MBEDTLS_SSL_EXT_MASK(PRE_SHARED_KEY) |         \
     MBEDTLS_SSL_EXT_MASK(PSK_KEY_EXCHANGE_MODES) | MBEDTLS_SSL_EXT_MASK(EARLY_DATA) | MBEDTLS_SSL_EXT_MASK(COOKIE) | \
     MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS) | MBEDTLS_SSL_EXT_MASK(CERT_AUTH) |                                     \
     MBEDTLS_SSL_EXT_MASK(POST_HANDSHAKE_AUTH) | MBEDTLS_SSL_EXT_MASK(SIG_ALG_CERT) |                                 \
     MBEDTLS_SSL_EXT_MASK(RECORD_SIZE_LIMIT) | MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)

/* RFC 8446 section 4.2. Allowed extensions for EncryptedExtensions */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_EE                                                                    \
    (MBEDTLS_SSL_EXT_MASK(SERVERNAME) | MBEDTLS_SSL_EXT_MASK(MAX_FRAGMENT_LENGTH) |                              \
     MBEDTLS_SSL_EXT_MASK(SUPPORTED_GROUPS) | MBEDTLS_SSL_EXT_MASK(USE_SRTP) | MBEDTLS_SSL_EXT_MASK(HEARTBEAT) | \
     MBEDTLS_SSL_EXT_MASK(ALPN) | MBEDTLS_SSL_EXT_MASK(CLI_CERT_TYPE) | MBEDTLS_SSL_EXT_MASK(SERV_CERT_TYPE) |   \
     MBEDTLS_SSL_EXT_MASK(EARLY_DATA) | MBEDTLS_SSL_EXT_MASK(RECORD_SIZE_LIMIT))

/* RFC 8446 section 4.2. Allowed extensions for CertificateRequest */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CR                                                                   \
    (MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST) | MBEDTLS_SSL_EXT_MASK(SIG_ALG) | MBEDTLS_SSL_EXT_MASK(SCT) |         \
     MBEDTLS_SSL_EXT_MASK(CERT_AUTH) | MBEDTLS_SSL_EXT_MASK(OID_FILTERS) | MBEDTLS_SSL_EXT_MASK(SIG_ALG_CERT) | \
     MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)

/* RFC 8446 section 4.2. Allowed extensions for Certificate */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CT (MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST) | MBEDTLS_SSL_EXT_MASK(SCT))

/* RFC 8446 section 4.2. Allowed extensions for ServerHello */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_SH \
    (MBEDTLS_SSL_EXT_MASK(KEY_SHARE) | MBEDTLS_SSL_EXT_MASK(PRE_SHARED_KEY) | MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS))

/* RFC 8446 section 4.2. Allowed extensions for HelloRetryRequest */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_HRR \
    (MBEDTLS_SSL_EXT_MASK(KEY_SHARE) | MBEDTLS_SSL_EXT_MASK(COOKIE) | MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS))

/* RFC 8446 section 4.2. Allowed extensions for NewSessionTicket */
#define MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_NST \
    (MBEDTLS_SSL_EXT_MASK(EARLY_DATA) | MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)
...
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_STREAM) || defined(MBEDTLS_SSL_SOME_SUITES_USE_CBC)
#define MBEDTLS_SSL_SOME_SUITES_USE_MAC
#endif

/* This macro determines whether a ciphersuite uses Encrypt-then-MAC with CBC */
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_CBC) && defined(MBEDTLS_SSL_ENCRYPT_THEN_MAC)
...
#define MBEDTLS_SSL_PAYLOAD_OVERHEAD \
    (MBEDTLS_MAX_IV_LENGTH + MBEDTLS_SSL_MAC_ADD + MBEDTLS_SSL_PADDING_ADD + MBEDTLS_SSL_MAX_CID_EXPANSION)
...
#define MBEDTLS_SSL_IN_BUFFER_LEN \
    ((MBEDTLS_SSL_HEADER_LEN) + (MBEDTLS_SSL_IN_PAYLOAD_LEN) + (MBEDTLS_SSL_CID_IN_LEN_MAX))
#endif
...
#define MBEDTLS_SSL_OUT_BUFFER_LEN \
    ((MBEDTLS_SSL_HEADER_LEN) + (MBEDTLS_SSL_OUT_PAYLOAD_LEN) + (MBEDTLS_SSL_CID_OUT_LEN_MAX))
#endif
...
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID)
    return mbedtls_ssl_get_output_max_frag_len(ctx) + MBEDTLS_SSL_HEADER_LEN + MBEDTLS_SSL_PAYLOAD_OVERHEAD +
...
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID)
    return mbedtls_ssl_get_input_max_frag_len(ctx) + MBEDTLS_SSL_HEADER_LEN + MBEDTLS_SSL_PAYLOAD_OVERHEAD +
...
struct mbedtls_ssl_handshake_params {
    ...
    defined(MBEDTLS_KEY_EXCHANGE_ECDSA_CERT_REQ_ANY_ALLOWED_ENABLED) || defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED)
    ...
    unsigned char randbytes[MBEDTLS_CLIENT_HELLO_RANDOM_LEN + MBEDTLS_SERVER_HELLO_RANDOM_LEN];
    /*!<  random bytes            */
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
...
struct mbedtls_ssl_transform {
    ...
    unsigned char randbytes[MBEDTLS_SERVER_HELLO_RANDOM_LEN + MBEDTLS_CLIENT_HELLO_RANDOM_LEN];
...
static inline void mbedtls_ssl_handshake_set_state(mbedtls_ssl_context* ssl, mbedtls_ssl_states state) {
    MBEDTLS_SSL_DEBUG_MSG(
        3, ("handshake state: %d (%s) -> %d (%s)", ssl->state, mbedtls_ssl_states_str((mbedtls_ssl_states)ssl->state),
...
#define MBEDTLS_SSL_PEND_FATAL_ALERT(type, user_return_value) mbedtls_ssl_pend_fatal_alert(ssl, type, user_return_value)
...
static inline int mbedtls_ssl_conf_is_tls13_only(const mbedtls_ssl_config* conf) {
    return conf->min_tls_version == MBEDTLS_SSL_VERSION_TLS1_3 && conf->max_tls_version == MBEDTLS_SSL_VERSION_TLS1_3;
}
...
static inline int mbedtls_ssl_conf_is_tls12_only(const mbedtls_ssl_config* conf) {
    return conf->min_tls_version == MBEDTLS_SSL_VERSION_TLS1_2 && conf->max_tls_version == MBEDTLS_SSL_VERSION_TLS1_2;
}
...
static inline int mbedtls_ssl_conf_is_hybrid_tls12_tls13(const mbedtls_ssl_config* conf) {
    return conf->min_tls_version == MBEDTLS_SSL_VERSION_TLS1_2 && conf->max_tls_version == MBEDTLS_SSL_VERSION_TLS1_3;
}
#endif /* MBEDTLS_SSL_PROTO_TLS1_2 && MBEDTLS_SSL_PROTO_TLS1_3 */

#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
extern const uint8_t mbedtls_ssl_tls13_hello_retry_request_magic[MBEDTLS_SERVER_HELLO_RANDOM_LEN];
MBEDTLS_CHECK_RETURN_CRITICAL
...
static inline void mbedtls_ssl_tls13_set_hs_sent_ext_mask(mbedtls_ssl_context* ssl, unsigned int extension_type) {
    ssl->handshake->sent_extensions |= mbedtls_ssl_get_extension_mask(extension_type);
}
...
static inline int mbedtls_ssl_tls12_named_group_is_ecdhe(uint16_t named_group) {
    ...
    return named_group == MBEDTLS_SSL_IANA_TLS_GROUP_X25519 || named_group == MBEDTLS_SSL_IANA_TLS_GROUP_BP256R1 ||
           ...
           named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP256K1 || named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP256R1 ||
           named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP384R1 || named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP521R1;
}

static inline int mbedtls_ssl_tls13_named_group_is_ecdhe(uint16_t named_group) {
    return named_group == MBEDTLS_SSL_IANA_TLS_GROUP_X25519 || named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP256R1 ||
           named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP384R1 || named_group == MBEDTLS_SSL_IANA_TLS_GROUP_SECP521R1 ||
           named_group == MBEDTLS_SSL_IANA_TLS_GROUP_X448;
}

static inline int mbedtls_ssl_tls13_named_group_is_ffdh(uint16_t named_group) {
    return named_group >= MBEDTLS_SSL_IANA_TLS_GROUP_FFDHE2048 && named_group <= MBEDTLS_SSL_IANA_TLS_GROUP_FFDHE8192;
}
...
static inline int mbedtls_ssl_named_group_is_supported(uint16_t named_group) {
    ...
    if (mbedtls_ssl_tls13_named_group_is_ecdhe(named_group)) {
        if (mbedtls_ssl_get_ecp_group_id_from_tls_id(named_group) != MBEDTLS_ECP_DP_NONE) {
            return 1;
        }
    }
#endif
...
static inline int mbedtls_ssl_get_pk_sigalg_and_md_alg_from_sig_alg(uint16_t sig_alg,
                                                                    mbedtls_pk_sigalg_t* pk_type,
                                                                    mbedtls_md_type_t* md_alg) {
...
typedef enum { MBEDTLS_ECJPAKE_ROUND_ONE, MBEDTLS_ECJPAKE_ROUND_TWO } mbedtls_ecjpake_rounds_t;
...
static inline unsigned int mbedtls_ssl_tls13_session_get_ticket_flags(mbedtls_ssl_session* session,
                                                                      unsigned int flags) {
    return session->ticket_flags & (flags & MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}

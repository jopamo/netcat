...
#define MBEDTLS_MPS_TRACE_MASK                                                                          \
    (MBEDTLS_MPS_TRACE_MASK_LAYER_1 | MBEDTLS_MPS_TRACE_MASK_LAYER_2 | MBEDTLS_MPS_TRACE_MASK_LAYER_3 | \
     MBEDTLS_MPS_TRACE_MASK_LAYER_4 | MBEDTLS_MPS_TRACE_MASK_READER | MBEDTLS_MPS_TRACE_MASK_WRITER)
...
#define MBEDTLS_MPS_TRACE_END(val)                                                                       \
    do {                                                                                                 \
        if (!(MBEDTLS_MPS_TRACE_MASK & (1u << mbedtls_mps_trace_id)))                                    \
            break;                                                                                       \
        MBEDTLS_MPS_TRACE(MBEDTLS_MPS_TRACE_TYPE_RETURN, "%d (-%#04x)", (int)(val), -((unsigned)(val))); \

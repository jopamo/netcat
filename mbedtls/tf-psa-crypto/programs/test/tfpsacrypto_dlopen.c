...
#pragma GCC diagnostic ignored "-Wpedantic"
    ...
    psa_status_t (*psa_hash_compute_ptr)(psa_algorithm_t, const uint8_t*, size_t, uint8_t*, size_t, size_t*) =
...
#pragma GCC diagnostic pop
    ...
    status = psa_hash_compute_ptr(PSA_ALG_SHA_256, input, sizeof(input) - 1, hash, sizeof(hash), &hash_len);
    if (status != PSA_SUCCESS) {

 ...
 */
#if defined(MBEDTLS_ECJPAKE_C) || defined(MBEDTLS_PEM_PARSE_C) || defined(MBEDTLS_ENTROPY_C) || \
...
#if defined(MBEDTLS_MD5_C) || defined(MBEDTLS_SHA1_C) || defined(MBEDTLS_SHA224_C) || defined(MBEDTLS_SHA256_C) || \
    defined(MBEDTLS_SHA384_C) || defined(MBEDTLS_SHA512_C) || defined(MBEDTLS_RIPEMD160_C)

...
#define MBEDTLS_ARCH_IS_ARM64
    ...
    (defined(__arm__) || defined(_M_ARM) || defined(_M_ARMT) || defined(__thumb__) || defined(__thumb2__))
#define MBEDTLS_ARCH_IS_ARM32
#endif

#if !defined(MBEDTLS_ARCH_IS_THUMB) && defined(_M_ARMT) || defined(__thumb__) || defined(__thumb2__)
#define MBEDTLS_ARCH_IS_THUMB
#endif

#if !defined(MBEDTLS_ARCH_IS_X64) && \
    (defined(__amd64__) || defined(__x86_64__) || ((defined(_M_X64) || defined(_M_AMD64)) && !defined(_M_ARM64EC)))
...
#if !defined(MBEDTLS_PLATFORM_IS_WINDOWS_ON_ARM64) && (defined(_M_ARM64) || defined(_M_ARM64EC))
...
#if defined(__GNUC__) && !defined(__ARMCC_VERSION) && !defined(__clang__) && !defined(__llvm__) && \
...
#error "Something went wrong: TF_PSA_CRYPTO_CONFIG_FILES_READ defined before reading the config files!"
#endif
#if defined(TF_PSA_CRYPTO_CONFIG_IS_FINALIZED)
#error "Something went wrong: TF_PSA_CRYPTO_CONFIG_IS_FINALIZED defined before reading the config files!"
#endif
...
#if (TF_PSA_CRYPTO_CONFIG_VERSION < 0x01000000) || (TF_PSA_CRYPTO_CONFIG_VERSION > TF_PSA_CRYPTO_VERSION_NUMBER)

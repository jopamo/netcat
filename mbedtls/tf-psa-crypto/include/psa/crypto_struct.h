...
#define PSA_KEY_ATTRIBUTES_INIT \
    {PSA_KEY_TYPE_NONE, 0, PSA_KEY_LIFETIME_VOLATILE, PSA_KEY_POLICY_INIT, MBEDTLS_SVC_KEY_ID_INIT}
...
static inline void psa_set_key_id(psa_key_attributes_t* attributes, mbedtls_svc_key_id_t key) {
    ...
    if (PSA_KEY_LIFETIME_IS_VOLATILE(lifetime)) {
        attributes->MBEDTLS_PRIVATE(lifetime) = PSA_KEY_LIFETIME_FROM_PERSISTENCE_AND_LOCATION(
...
#else
#define PSA_GENERATE_KEY_IOP_INIT {0, MBEDTLS_PSA_GENERATE_KEY_IOP_INIT, PSA_KEY_ATTRIBUTES_INIT, 0, 0}
#endif

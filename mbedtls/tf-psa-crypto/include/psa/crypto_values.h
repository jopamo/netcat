...
#define PSA_KEY_TYPE_ECC_GET_FAMILY(type) \
    ((psa_ecc_family_t)(PSA_KEY_TYPE_HAS_ECC_FAMILY(type) ? ((type) & PSA_KEY_TYPE_ECC_CURVE_MASK) : 0))
...
#define PSA_ALG_AEAD_WITH_DEFAULT_LENGTH_TAG(aead_alg)                                                           \
    (PSA_ALG_AEAD_WITH_DEFAULT_LENGTH_TAG_CASE(aead_alg, PSA_ALG_CCM) PSA_ALG_AEAD_WITH_DEFAULT_LENGTH_TAG_CASE( \
        aead_alg, PSA_ALG_GCM) PSA_ALG_AEAD_WITH_DEFAULT_LENGTH_TAG_CASE(aead_alg, PSA_ALG_CHACHA20_POLY1305) 0)

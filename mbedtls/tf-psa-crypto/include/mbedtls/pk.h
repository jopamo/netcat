...
#if defined(MBEDTLS_RSA_C) && MBEDTLS_MPI_MAX_SIZE > MBEDTLS_PK_SIGNATURE_MAX_SIZE
...
#define MBEDTLS_PK_MAX_PUBKEY_RAW_LEN                                                                         \
    (MBEDTLS_PK_MAX_EC_PUBKEY_RAW_LEN > MBEDTLS_PK_MAX_RSA_PUBKEY_RAW_LEN) ? MBEDTLS_PK_MAX_EC_PUBKEY_RAW_LEN \

...
#define MBEDTLS_ASN1_IS_STRING_TAG(tag)                                                      \
    ((unsigned int)(tag) < 32u &&                                                            \
     (((1u << (tag)) & ((1u << MBEDTLS_ASN1_BMP_STRING) | (1u << MBEDTLS_ASN1_UTF8_STRING) | \
                        (1u << MBEDTLS_ASN1_T61_STRING) | (1u << MBEDTLS_ASN1_IA5_STRING) |  \
                        (1u << MBEDTLS_ASN1_UNIVERSAL_STRING) | (1u << MBEDTLS_ASN1_PRINTABLE_STRING))) != 0))
...
#if defined(MBEDTLS_ASN1_PARSE_C) || defined(MBEDTLS_ASN1_WRITE_C) || defined(PSA_HAVE_ALG_SOME_ECDSA)
/**
...
int mbedtls_asn1_get_integer(unsigned char** p, const unsigned char* end, unsigned char** head, size_t* length);
/**

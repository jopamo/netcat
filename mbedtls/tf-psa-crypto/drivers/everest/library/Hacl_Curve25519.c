 ...
 * /mnt/e/everest/verify/hdrcLh -minimal -fbuiltin-uint128 -fc89 -fparentheses -fno-shadow -header
 * /mnt/e/everest/verify/hdrcLh -minimal -I /mnt/e/everest/verify/hacl-star/code/lib/kremlin -I
 * /mnt/e/everest/verify/kremlin/kremlib/compat -I /mnt/e/everest/verify/hacl-star/specs -I
 * /mnt/e/everest/verify/hacl-star/specs/old -I . -ccopt -march=native -verbose -ldopt -flto -tmpdir x25519-c -I
 * ../bignum -bundle Hacl.Curve25519=* -minimal -add-include "kremlib.h" -skip-compilation x25519-c/out.krml -o
...
inline static void Hacl_Bignum_Fproduct_sum_scalar_multiplication_(uint128_t* output, uint64_t* input, uint64_t s) {
    uint32_t i;
    for (i = (uint32_t)0U; i < (uint32_t)5U; i = i + (uint32_t)1U) {
...
static void Hacl_Bignum_Fmul_mul_shift_reduce_(uint128_t* output, uint64_t* input, uint64_t* input2) {
    uint32_t i;
    uint64_t input2i;
    {
        uint32_t i0;
...
static void Hacl_Bignum_Fsquare_fsquare_times_(uint64_t* input, uint128_t* tmp, uint32_t count1) {
    uint32_t i;

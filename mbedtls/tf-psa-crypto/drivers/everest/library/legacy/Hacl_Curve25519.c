 ...
 * KreMLin invocation: /mnt/e/everest/verify/kremlin/krml -fc89 -fparentheses -fno-shadow -header
 * /mnt/e/everest/verify/hdrcLh -minimal -fc89 -fparentheses -fno-shadow -header /mnt/e/everest/verify/hdrcLh -minimal
 * -I /mnt/e/everest/verify/hacl-star/code/lib/kremlin -I /mnt/e/everest/verify/kremlin/kremlib/compat -I
 * /mnt/e/everest/verify/hacl-star/specs -I /mnt/e/everest/verify/hacl-star/specs/old -I . -ccopt -march=native -verbose
 * -ldopt -flto -tmpdir x25519-c -I ../bignum -bundle Hacl.Curve25519=* -minimal -add-include "kremlib.h"
 * -skip-compilation x25519-c/out.krml -o x25519-c/Hacl_Curve25519.c F* version: 059db0c8 KreMLin version: 916c37ac
 */
...
extern FStar_UInt128_uint128 FStar_UInt128_add(FStar_UInt128_uint128 x0, FStar_UInt128_uint128 x1);

extern FStar_UInt128_uint128 FStar_UInt128_add_mod(FStar_UInt128_uint128 x0, FStar_UInt128_uint128 x1);

extern FStar_UInt128_uint128 FStar_UInt128_logand(FStar_UInt128_uint128 x0, FStar_UInt128_uint128 x1);
...
inline static void Hacl_Bignum_Fproduct_copy_from_wide_(uint64_t* output, FStar_UInt128_uint128* input) {
    uint32_t i;
...
inline static void Hacl_Bignum_Fproduct_sum_scalar_multiplication_(FStar_UInt128_uint128* output,
                                                                   uint64_t* input,
                                                                   uint64_t s) {
    uint32_t i;
    for (i = (uint32_t)0U; i < (uint32_t)5U; i = i + (uint32_t)1U) {
...
static void Hacl_Bignum_Fmul_mul_shift_reduce_(FStar_UInt128_uint128* output, uint64_t* input, uint64_t* input2) {
    uint32_t i;
    uint64_t input2i;
    {
        uint32_t i0;
        ...
        }
        {
            ...
            b0_ = FStar_UInt128_add(
                b0, FStar_UInt128_mul_wide(
                        (uint64_t)19U, FStar_UInt128_uint128_to_uint64(FStar_UInt128_shift_right(b4, (uint32_t)51U))));
            t[4U] = b4_;
            t[0U] = b0_;
...
inline static void Hacl_Bignum_Fsquare_fsquare__(FStar_UInt128_uint128* tmp, uint64_t* output) {
    ...
    FStar_UInt128_uint128 s0 =
        FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(r0, r0), FStar_UInt128_mul_wide(d4, r1)),
                          FStar_UInt128_mul_wide(d2, r3));
    FStar_UInt128_uint128 s1 =
        FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(d0, r1), FStar_UInt128_mul_wide(d4, r2)),
                          FStar_UInt128_mul_wide(r3 * (uint64_t)19U, r3));
    FStar_UInt128_uint128 s2 =
        FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(d0, r2), FStar_UInt128_mul_wide(r1, r1)),
                          FStar_UInt128_mul_wide(d4, r3));
    FStar_UInt128_uint128 s3 =
        FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(d0, r3), FStar_UInt128_mul_wide(d1, r2)),
                          FStar_UInt128_mul_wide(r4, d419));
    FStar_UInt128_uint128 s4 =
        FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(d0, r4), FStar_UInt128_mul_wide(d1, r3)),
...
inline static void Hacl_Bignum_Fsquare_fsquare_(FStar_UInt128_uint128* tmp, uint64_t* output) {
    ...
    b4_ = FStar_UInt128_logand(b4, FStar_UInt128_uint64_to_uint128((uint64_t)0x7ffffffffffffU));
    b0_ = FStar_UInt128_add(
        b0, FStar_UInt128_mul_wide((uint64_t)19U,
...
static void Hacl_Bignum_Fsquare_fsquare_times_(uint64_t* input, FStar_UInt128_uint128* tmp, uint32_t count1) {
    uint32_t i;
...
inline static void Hacl_Bignum_Fsquare_fsquare_times(uint64_t* output, uint64_t* input, uint32_t count1) {
    KRML_CHECK_SIZE(sizeof(FStar_UInt128_uint128), (uint32_t)5U);
    {
        FStar_UInt128_uint128 t[5U];
        {
...
static void Hacl_EC_Point_swap_conditional_step(uint64_t* a, uint64_t* b, uint64_t swap1, uint32_t ctr) {
...
static void Hacl_EC_Point_swap_conditional_(uint64_t* a, uint64_t* b, uint64_t swap1, uint32_t ctr) {
    if (!(ctr == (uint32_t)0U)) {
        uint32_t i;
...
static void Hacl_EC_Point_copy(uint64_t* output, uint64_t* input) {
    memcpy(output, input, (uint32_t)5U * sizeof input[0U]);
    memcpy(output + (uint32_t)5U, input + (uint32_t)5U, (uint32_t)5U * sizeof(input + (uint32_t)5U)[0U]);
}
...
static void Hacl_EC_AddAndDouble_fmonty(uint64_t* pp, uint64_t* ppq, uint64_t* p, uint64_t* pq, uint64_t* qmqp) {
    uint64_t* qx = qmqp;
    uint64_t* x2 = pp;
...
static void Hacl_EC_Ladder_SmallLoop_cmult_small_loop_double_step(uint64_t* nq,
                                                                  uint64_t* nqpq,
                                                                  uint64_t* nq2,
                                                                  uint64_t* nqpq2,
                                                                  uint64_t* q,

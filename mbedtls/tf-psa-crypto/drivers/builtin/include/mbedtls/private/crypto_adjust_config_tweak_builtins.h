 ...
 * in PSA. */
    ...
    (defined(MBEDTLS_PSA_BUILTIN_ALG_STREAM_CIPHER) || defined(MBEDTLS_PSA_BUILTIN_ALG_CTR) ||             \
     defined(MBEDTLS_PSA_BUILTIN_ALG_CFB) || defined(MBEDTLS_PSA_BUILTIN_ALG_OFB) ||                       \
     defined(MBEDTLS_PSA_BUILTIN_ALG_ECB_NO_PADDING) || defined(MBEDTLS_PSA_BUILTIN_ALG_CBC_NO_PADDING) || \
...
#if defined(MBEDTLS_BLOCK_CIPHER_AES_VIA_PSA) || defined(MBEDTLS_BLOCK_CIPHER_AES_VIA_LEGACY)
#define MBEDTLS_BLOCK_CIPHER_CAN_AES
#endif
#if defined(MBEDTLS_BLOCK_CIPHER_ARIA_VIA_PSA) || defined(MBEDTLS_BLOCK_CIPHER_ARIA_VIA_LEGACY)
#define MBEDTLS_BLOCK_CIPHER_CAN_ARIA
#endif
#if defined(MBEDTLS_BLOCK_CIPHER_CAMELLIA_VIA_PSA) || defined(MBEDTLS_BLOCK_CIPHER_CAMELLIA_VIA_LEGACY)

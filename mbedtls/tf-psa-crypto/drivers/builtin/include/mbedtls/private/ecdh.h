...
#ifndef TF_PSA_CRYPTO_MBEDTLS_PRIVATE_ECDH_H
...
#if defined(MBEDTLS_ECP_RESTARTABLE)
#define MBEDTLS_ECDH_CONTEXT_MBED_INIT                                 \
    {MBEDTLS_ECP_GROUP_INIT, MBEDTLS_MPI_INIT, MBEDTLS_ECP_POINT_INIT, \
     MBEDTLS_ECP_POINT_INIT, MBEDTLS_MPI_INIT, MBEDTLS_ECP_RESTART_INIT}
#else
#define MBEDTLS_ECDH_CONTEXT_MBED_INIT \
    {MBEDTLS_ECP_GROUP_INIT, MBEDTLS_MPI_INIT, MBEDTLS_ECP_POINT_INIT, MBEDTLS_ECP_POINT_INIT, MBEDTLS_MPI_INIT}
#endif
...
#if defined(MBEDTLS_ECDH_LEGACY_CONTEXT)
#if defined(MBEDTLS_ECP_RESTARTABLE)
#define MBEDTLS_ECDH_CONTEXT_INIT                          \
    {MBEDTLS_ECP_GROUP_INIT,  MBEDTLS_MPI_INIT,            \
     MBEDTLS_ECP_POINT_INIT,  MBEDTLS_ECP_POINT_INIT,      \
     MBEDTLS_MPI_INIT,        MBEDTLS_ECP_PF_UNCOMPRESSED, \
     MBEDTLS_ECP_POINT_INIT,  MBEDTLS_ECP_POINT_INIT,      \
     MBEDTLS_MPI_INIT,        0,                           \
...
#define MBEDTLS_ECDH_CONTEXT_INIT                                                 \
    {MBEDTLS_ECP_GROUP_INIT, MBEDTLS_MPI_INIT,       MBEDTLS_ECP_POINT_INIT,      \
     MBEDTLS_ECP_POINT_INIT, MBEDTLS_MPI_INIT,       MBEDTLS_ECP_PF_UNCOMPRESSED, \
     MBEDTLS_ECP_POINT_INIT, MBEDTLS_ECP_POINT_INIT, MBEDTLS_MPI_INIT}
#endif /* MBEDTLS_ECP_RESTARTABLE */
#else
#if defined(MBEDTLS_ECP_RESTARTABLE)
#define MBEDTLS_ECDH_CONTEXT_INIT \
    {MBEDTLS_ECP_PF_UNCOMPRESSED, MBEDTLS_ECP_DP_NONE, MBEDTLS_ECDH_VARIANT_NONE, {MBEDTLS_ECDH_CONTEXT_MBED_INIT}, 0}
#else
#define MBEDTLS_ECDH_CONTEXT_INIT                                                      \
    {                                                                                  \
        MBEDTLS_ECP_PF_UNCOMPRESSED, MBEDTLS_ECP_DP_NONE, MBEDTLS_ECDH_VARIANT_NONE, { \
...
#endif /* TF_PSA_CRYPTO_MBEDTLS_PRIVATE_ECDH_H */

...
#if defined(MBEDTLS_AESCE_C) && defined(MBEDTLS_ARCH_IS_ARMV8_A) && defined(MBEDTLS_HAVE_NEON_INTRINSICS) && \
...
#define MBEDTLS_AESCE_HAS_SUPPORT() \
    (mbedtls_aesce_has_support_result == -1 ? mbedtls_aesce_has_support_impl() : mbedtls_aesce_has_support_result)

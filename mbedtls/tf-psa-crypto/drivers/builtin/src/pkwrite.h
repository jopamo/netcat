 ...
 */
#define MBEDTLS_PK_RSA_PUB_DER_MAX_BYTES 23 + PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS)
 ...
 *  }
 */
#define MBEDTLS_PK_RSA_PRV_DER_MAX_BYTES PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS)
 ...
 * supported curves. */
#define MBEDTLS_PK_MAX_ECC_BYTES                                              \
    (PSA_BITS_TO_BYTES(PSA_VENDOR_ECC_MAX_CURVE_BITS) > MBEDTLS_ECP_MAX_BYTES \

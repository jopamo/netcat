...
#if defined(MBEDTLS_AESNI_C) && (defined(MBEDTLS_ARCH_IS_X64) || defined(MBEDTLS_ARCH_IS_X86))
...
#elif defined(MBEDTLS_HAVE_ASM) && (defined(__GNUC__) || defined(__clang__)) && defined(MBEDTLS_ARCH_IS_X64)

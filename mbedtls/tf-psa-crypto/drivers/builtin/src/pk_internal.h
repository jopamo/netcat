...
#define PSA_PK_RSA_TO_MBEDTLS_ERR(status) \
    PSA_TO_MBEDTLS_ERR_LIST(status, psa_to_pk_rsa_errors, psa_pk_status_to_mbedtls)
#define PSA_PK_ECDSA_TO_MBEDTLS_ERR(status) \
    PSA_TO_MBEDTLS_ERR_LIST(status, psa_to_pk_ecdsa_errors, psa_pk_status_to_mbedtls)
...
#define MBEDTLS_PK_IS_RFC8410_GROUP_ID(id) ((id == MBEDTLS_ECP_DP_CURVE25519) || (id == MBEDTLS_ECP_DP_CURVE448))

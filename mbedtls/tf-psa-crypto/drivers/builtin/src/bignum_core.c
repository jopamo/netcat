...
mbedtls_ct_condition_t mbedtls_mpi_core_uint_le_mpi(mbedtls_mpi_uint min, const mbedtls_mpi_uint* A, size_t A_limbs) {
...
mbedtls_ct_condition_t mbedtls_mpi_core_lt_ct(const mbedtls_mpi_uint* A, const mbedtls_mpi_uint* B, size_t limbs) {
...
void mbedtls_mpi_core_cond_swap(mbedtls_mpi_uint* X, mbedtls_mpi_uint* Y, size_t limbs, mbedtls_ct_condition_t swap) {
    if (X == Y) {
        return;
    }
...
int mbedtls_mpi_core_write_be(const mbedtls_mpi_uint* X, size_t X_limbs, unsigned char* output, size_t output_length) {
    size_t stored_bytes;
    size_t bytes_to_copy;
    unsigned char* p;
...
mbedtls_mpi_uint mbedtls_mpi_core_mla(mbedtls_mpi_uint* d,
                                      size_t d_len,
...
void mbedtls_mpi_core_montmul(mbedtls_mpi_uint* X,
     ...
     */
    mbedtls_ct_memcpy_if(mbedtls_ct_bool(carry ^ borrow), (unsigned char*)X, (unsigned char*)T, NULL,
 ...
 */
int mbedtls_mpi_core_fill_random(mbedtls_mpi_uint* X,
                                 size_t X_limbs,
                                 size_t n_bytes,
...
static void mbedtls_mpi_core_exp_mod_optionally_safe(mbedtls_mpi_uint* X,
    ...
    do {
        ...
        if (window_bits == wsize || (E_bit_index == 0 && E_limb_index == 0)) {
            exp_mod_table_lookup_optionally_safe(Wselect, Wtable, AN_limbs, welem, window, E_public);
...
void mbedtls_mpi_core_exp_mod(mbedtls_mpi_uint* X,
                              ...
                              const mbedtls_mpi_uint* RR,
                              mbedtls_mpi_uint* T) {
    mbedtls_mpi_core_exp_mod_optionally_safe(X, A, N, AN_limbs, E, E_limbs, MBEDTLS_MPI_IS_SECRET, RR, T);
}
...
void mbedtls_mpi_core_exp_mod_unsafe(mbedtls_mpi_uint* X,
                                     ...
                                     const mbedtls_mpi_uint* RR,
                                     mbedtls_mpi_uint* T) {
    mbedtls_mpi_core_exp_mod_optionally_safe(X, A, N, AN_limbs, E, E_limbs, MBEDTLS_MPI_IS_PUBLIC, RR, T);
}

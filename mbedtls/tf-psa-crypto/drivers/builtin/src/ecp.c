...
#if defined(MBEDTLS_ECP_SHORT_WEIERSTRASS_ENABLED)
static int mbedtls_ecp_sw_derive_y(const mbedtls_ecp_group* grp, const mbedtls_mpi* X, mbedtls_mpi* Y, int parity_bit);
...
#define MPI_ECP_INV(dst, src) MBEDTLS_MPI_CHK(mbedtls_mpi_gcd_modinv_odd(NULL, (dst), (src), &grp->P))

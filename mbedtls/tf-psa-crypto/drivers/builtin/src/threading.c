...
static int (*cond_wait_ptr)(mbedtls_platform_condition_variable_t*, mbedtls_platform_mutex_t*) = NULL;
 ...
 */
void mbedtls_threading_set_alt(int (*mutex_init)(mbedtls_platform_mutex_t*),

...
#if defined(PSA_WANT_ALG_CCM) && !(defined(PSA_WANT_KEY_TYPE_AES) || defined(PSA_WANT_KEY_TYPE_CAMELLIA))
#error "PSA_WANT_ALG_CCM defined, but not all prerequisites"
#endif

#if defined(PSA_WANT_ALG_CMAC) && !(defined(PSA_WANT_KEY_TYPE_AES) || defined(PSA_WANT_KEY_TYPE_CAMELLIA))
#error "PSA_WANT_ALG_CMAC defined, but not all prerequisites"
#endif

#if defined(PSA_WANT_ALG_DETERMINISTIC_ECDSA) && \
    !(defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC) || defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY))
...
#if defined(PSA_WANT_ALG_GCM) && !(defined(PSA_WANT_KEY_TYPE_AES) || defined(PSA_WANT_KEY_TYPE_CAMELLIA))
#error "PSA_WANT_ALG_GCM defined, but not all prerequisites"
#endif

#if defined(PSA_WANT_ALG_RSA_PKCS1V15_CRYPT) && \
    !(defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_BASIC) || defined(PSA_WANT_KEY_TYPE_RSA_PUBLIC_KEY))
...
#if (defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC) || defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_IMPORT) ||    \
     defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_GENERATE) || \
     defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_DERIVE)) &&                                                    \
    !defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY)
#error "PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_xxx defined, but not all prerequisites"
#endif

#if (defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_BASIC) || defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_IMPORT) ||     \
     defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_GENERATE)) && \
    !defined(PSA_WANT_KEY_TYPE_RSA_PUBLIC_KEY)
#error "PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_xxx defined, but not all prerequisites"
#endif

#if (defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_BASIC) || defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_IMPORT) ||     \
     defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_GENERATE)) && \
...
#if defined(PSA_WANT_ALG_TLS12_ECJPAKE_TO_PMS) && !defined(PSA_WANT_ALG_SHA_256)

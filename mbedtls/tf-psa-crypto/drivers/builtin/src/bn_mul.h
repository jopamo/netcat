...
#define MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d)                                                     \
    ((mbedtls_mpi_uint)(a) << 0) | ((mbedtls_mpi_uint)(b) << 8) | ((mbedtls_mpi_uint)(c) << 16) | \
        ((mbedtls_mpi_uint)(d) << 24)

#define MBEDTLS_BYTES_TO_T_UINT_2(a, b) MBEDTLS_BYTES_TO_T_UINT_4(a, b, 0, 0)

#define MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h) \
    MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d), MBEDTLS_BYTES_TO_T_UINT_4(e, f, g, h)

#else /* 64-bits */

#define MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h)                                               \
    ((mbedtls_mpi_uint)(a) << 0) | ((mbedtls_mpi_uint)(b) << 8) | ((mbedtls_mpi_uint)(c) << 16) |       \
        ((mbedtls_mpi_uint)(d) << 24) | ((mbedtls_mpi_uint)(e) << 32) | ((mbedtls_mpi_uint)(f) << 40) | \
        ((mbedtls_mpi_uint)(g) << 48) | ((mbedtls_mpi_uint)(h) << 56)

#define MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d) MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, 0, 0, 0, 0)

#define MBEDTLS_BYTES_TO_T_UINT_2(a, b) MBEDTLS_BYTES_TO_T_UINT_8(a, b, 0, 0, 0, 0, 0, 0)
...
#define MULADDC_X1_INIT \
    do {                \
        uintptr_t muladdc_d = (uintptr_t)d, muladdc_s = (uintptr_t)s; asm(
...
#define MULADDC_X1_STOP                               \
    ...
    d = (mbedtls_mpi_uint*)muladdc_d;                 \
    s = (mbedtls_mpi_uint*)muladdc_s;                 \
    }                                                 \
    while (0)                                         \
        ;
...
#define MULADDC_X1_INIT __asm mov esi, s __asm mov edi, d __asm mov ecx, c __asm mov ebx, b

#define MULADDC_X1_CORE                                                                                                \
    __asm lodsd __asm mul ebx __asm add eax, ecx __asm adc edx, 0 __asm add eax, [edi] __asm adc edx, 0 __asm mov ecx, \
        edx __asm stosd

#define MULADDC_X1_STOP __asm mov c, ecx __asm mov d, edi __asm mov s, esi
...
#define MULADDC_X8_STOP EMIT 0x0F EMIT 0x77 __asm mov c, ecx __asm mov d, edi __asm mov s, esi

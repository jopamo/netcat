...
#define MBEDTLS_LMOTS_PUBLIC_KEY_LEN(type) \
    (MBEDTLS_LMOTS_TYPE_LEN + MBEDTLS_LMOTS_I_KEY_ID_LEN + MBEDTLS_LMOTS_Q_LEAF_ID_LEN + MBEDTLS_LMOTS_N_HASH_LEN(type))
...
#define MBEDTLS_LMOTS_SIG_SIGNATURE_OFFSET(type) \
    (MBEDTLS_LMOTS_SIG_C_RANDOM_OFFSET + MBEDTLS_LMOTS_C_RANDOM_VALUE_LEN(type))

 ...
 */
static inline unsigned char* psa_crypto_buffer_offset(unsigned char* p, size_t n) {
 ...
 *              buffer is at least \p n + 1.
 */
static inline const unsigned char* psa_crypto_buffer_offset_const(const unsigned char* p, size_t n) {
    return p == NULL ? NULL : p + n;
}

 ...
 */
static inline unsigned char* mbedtls_buffer_offset(unsigned char* p, size_t n) {
...
#if defined(MBEDTLS_HAVE_NEON_INTRINSICS) && (!(defined(MBEDTLS_COMPILER_IS_GCC) && MBEDTLS_GCC_VERSION < 70300))
...
#elif !defined(__cplusplus) && ((defined(__GNUC__) && ((__GNUC__ == 4 && __GNUC_MINOR >= 6) || __GNUC__ > 4)) || \

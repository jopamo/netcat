...
static void psa_its_fill_filename(psa_storage_uid_t uid, char* filename) {
    ...
    mbedtls_snprintf(filename, PSA_ITS_STORAGE_FILENAME_LENGTH, "%s" PSA_ITS_STORAGE_FILENAME_PATTERN "%s",
                     PSA_ITS_STORAGE_PREFIX, (unsigned)(uid >> 32), (unsigned)(uid & 0xffffffff),

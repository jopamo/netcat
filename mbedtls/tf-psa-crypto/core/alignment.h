 ...
 */
#if defined(__ARM_FEATURE_UNALIGNED) || defined(MBEDTLS_ARCH_IS_X86) || defined(MBEDTLS_ARCH_IS_X64) || \
...
#if defined(__IAR_SYSTEMS_ICC__) && (defined(MBEDTLS_ARCH_IS_ARM64) || defined(MBEDTLS_ARCH_IS_ARM32) || \

 ...
 * Note: no need to check X.509 as it depends on PK. */
    ...
    defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_512) || defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_255) ||     \
    defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_448) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_256) ||            \
    defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_256) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_384) ||               \
...
#error "Unsupported partial support for ECC curves acceleration, see docs/driver-only-builds.md"
    ...
    !(defined(MBEDTLS_AES_C) ||    \
      (defined(MBEDTLS_PSA_CRYPTO_CLIENT) && defined(PSA_WANT_KEY_TYPE_AES) && defined(PSA_WANT_ALG_ECB_NO_PADDING)))
#error "MBEDTLS_CTR_DRBG_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_CMAC_C) && (!defined(MBEDTLS_CIPHER_C) || !defined(MBEDTLS_AES_C))
...
#error "MBEDTLS_BLOCK_CIPHER_NO_DECRYPT and MBEDTLS_NIST_KW_C cannot be defined simultaneously"
    ...
    !(defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED) || \
      defined(MBEDTLS_ECP_DP_SECP521R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP256K1_ENABLED) || \
...
#error "MBEDTLS_ECP_RESTARTABLE defined, but not all prerequisites"
    ...
    (!defined(MBEDTLS_BIGNUM_C) ||                                                                 \
     (!defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) && !defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED) &&  \
      ...
      !defined(MBEDTLS_ECP_DP_SECP256K1_ENABLED) && !defined(MBEDTLS_ECP_DP_CURVE25519_ENABLED) && \
...
#if defined(MBEDTLS_ENTROPY_C) && !(defined(PSA_WANT_ALG_SHA_512) || defined(PSA_WANT_ALG_SHA_256))
#error "Entropy module enabled but neither SHA-256 nor SHA-512 is available"
#endif

#if (MBEDTLS_PSA_CRYPTO_RNG_STRENGTH != 128) && (MBEDTLS_PSA_CRYPTO_RNG_STRENGTH != 256)
...
#undef MBEDTLS_HAS_MEMSAN  // temporary macro defined above
    ...
    !(defined(MBEDTLS_CCM_GCM_CAN_AES) || defined(MBEDTLS_CCM_GCM_CAN_ARIA) || defined(MBEDTLS_CCM_GCM_CAN_CAMELLIA))
...
#if defined(MBEDTLS_MD_C) && !defined(PSA_WANT_ALG_MD5) && !defined(PSA_WANT_ALG_RIPEMD160) &&             \
    !defined(PSA_WANT_ALG_SHA_1) && !defined(PSA_WANT_ALG_SHA_224) && !defined(PSA_WANT_ALG_SHA_256) &&    \
    !defined(PSA_WANT_ALG_SHA_384) && !defined(PSA_WANT_ALG_SHA_512) && !defined(PSA_WANT_ALG_SHA3_224) && \
    !defined(PSA_WANT_ALG_SHA3_256) && !defined(PSA_WANT_ALG_SHA3_384) && !defined(PSA_WANT_ALG_SHA3_512)
#error "MBEDTLS_MD_C defined, but no hash algorithm"
#endif

#if defined(MBEDTLS_LMS_C) && !(defined(MBEDTLS_PSA_CRYPTO_CLIENT) && defined(PSA_WANT_ALG_SHA_256))
...
#if defined(MBEDTLS_PK_C) && !defined(PSA_WANT_KEY_TYPE_RSA_PUBLIC_KEY) && !defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY)
...
#if defined(MBEDTLS_PK_PARSE_C) && (!defined(MBEDTLS_ASN1_PARSE_C) || !defined(MBEDTLS_PK_C))
#error "MBEDTLS_PK_PARSE_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_PK_WRITE_C) && (!defined(MBEDTLS_ASN1_WRITE_C) || !defined(MBEDTLS_PK_C))
...
#error "MBEDTLS_PLATFORM_SETBUF_MACRO defined, but not all prerequisites"
    ...
    (defined(MBEDTLS_PLATFORM_STD_SETBUF) || defined(MBEDTLS_PLATFORM_SETBUF_ALT))
#error \
    "MBEDTLS_PLATFORM_SETBUF_MACRO and MBEDTLS_PLATFORM_STD_SETBUF/MBEDTLS_PLATFORM_SETBUF_ALT cannot be defined simultaneously"
#endif
...
#error "MBEDTLS_PLATFORM_VSNPRINTF_MACRO defined, but not all prerequisites"
    ...
    (defined(MBEDTLS_PLATFORM_STD_VSNPRINTF) || defined(MBEDTLS_PLATFORM_VSNPRINTF_ALT))
#error \
    "MBEDTLS_PLATFORM_VSNPRINTF_MACRO and MBEDTLS_PLATFORM_STD_VSNPRINTF/MBEDTLS_PLATFORM_VSNPRINTF_ALT cannot be defined simultaneously"
#endif
...
#if defined(MBEDTLS_ENTROPY_NV_SEED) && (!defined(MBEDTLS_PSA_CRYPTO_C) || !defined(MBEDTLS_PLATFORM_C))
...
#error "MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO and MBEDTLS_PLATFORM_STD_NV_SEED_WRITE cannot be defined simultaneously"
    ...
    !(defined(MBEDTLS_CTR_DRBG_C) || defined(MBEDTLS_HMAC_DRBG_C) || defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG))
#error "MBEDTLS_PSA_CRYPTO_C defined, but missing RNG"
#endif

#if defined(MBEDTLS_PSA_CRYPTO_C) && defined(PSA_HAVE_SOFT_BLOCK_MODE) && defined(PSA_HAVE_SOFT_BLOCK_CIPHER) && \
...
#if defined(MBEDTLS_PSA_KEY_STORE_DYNAMIC) && defined(MBEDTLS_PSA_STATIC_KEY_SLOTS)

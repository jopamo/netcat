...
MBEDTLS_STATIC_ASSERT(
    PSA_BYTES_TO_BITS(PSA_HASH_LENGTH(MBEDTLS_PSA_CRYPTO_RNG_HASH)) >= MBEDTLS_PSA_CRYPTO_RNG_STRENGTH,
...
#if (MBEDTLS_PSA_CRYPTO_RNG_STRENGTH > 128) && defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
...
static inline int mbedtls_psa_drbg_seed(mbedtls_psa_drbg_context_t* drbg_ctx,
    ...
    if (PSA_BYTES_TO_BITS(PSA_HASH_LENGTH(MBEDTLS_PSA_CRYPTO_RNG_HASH)) < MBEDTLS_PSA_CRYPTO_RNG_STRENGTH) {

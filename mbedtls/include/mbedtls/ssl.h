 ...
 */
#if defined(MBEDTLS_SSL_PROTO_TLS1_3) && defined(MBEDTLS_SSL_SESSION_TICKETS) && defined(PSA_WANT_KEY_TYPE_AES) && \
    defined(PSA_WANT_ALG_GCM) && defined(PSA_WANT_ALG_SHA_384)
...
#define MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK                                                                     \
    (MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_PSK_RESUMPTION | MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_PSK_EPHEMERAL_RESUMPTION | \
...
#if defined(MBEDTLS_SSL_SESSION_TICKETS) && defined(MBEDTLS_SSL_SRV_C) && defined(MBEDTLS_HAVE_TIME)
...
struct mbedtls_ssl_config {
    ...
    int (*MBEDTLS_PRIVATE(
        f_ticket_write))(void*, const mbedtls_ssl_session*, unsigned char*, const unsigned char*, size_t*, uint32_t*);
 ...
 */
static inline unsigned const char (*mbedtls_ssl_session_get_id(const mbedtls_ssl_session* session))[32] {

...
#define MBEDTLS_OID_AT_UNIQUE_IDENTIFIER                                                                         \
    MBEDTLS_OID_AT "\x2D"                                 /**< id-at-uniqueIdentifier AttributeType:= {id-at 45} \
                                                           */
...
#define MBEDTLS_OID_DOMAIN_COMPONENT                                                                                  \
    "\x09\x92\x26\x89\x93\xF2\x2C\x64\x01\x19" /** id-domainComponent AttributeType:= {itu-t(0) data(9) pss(2342)     \
                                                  ucl(19200300) pilot(100) pilotAttributeType(1) domainComponent(25)} \
                                                */
...
#define MBEDTLS_OID_PKCS7 \
    MBEDTLS_OID_PKCS      \
    "\x07" /**< pkcs-7 OBJECT IDENTIFIER ::= { iso(1) member-body(2) us(840) rsadsi(113549) pkcs(1) 7 } */
...
#define MBEDTLS_OID_PKCS7_SIGNED_DATA \
    MBEDTLS_OID_PKCS7 "\x02" /**< Content type is Signed Data OBJECT IDENTIFIER ::= {pkcs-7 2} */
#define MBEDTLS_OID_PKCS7_ENVELOPED_DATA \
    MBEDTLS_OID_PKCS7 "\x03" /**< Content type is Enveloped Data OBJECT IDENTIFIER ::= {pkcs-7 3} */
#define MBEDTLS_OID_PKCS7_SIGNED_AND_ENVELOPED_DATA \
    MBEDTLS_OID_PKCS7 "\x04" /**< Content type is Signed and Enveloped Data OBJECT IDENTIFIER ::= {pkcs-7 4} */
#define MBEDTLS_OID_PKCS7_DIGESTED_DATA \
    MBEDTLS_OID_PKCS7 "\x05" /**< Content type is Digested Data OBJECT IDENTIFIER ::= {pkcs-7 5} */
#define MBEDTLS_OID_PKCS7_ENCRYPTED_DATA \
    MBEDTLS_OID_PKCS7 "\x06" /**< Content type is Encrypted Data OBJECT IDENTIFIER ::= {pkcs-7 6} */

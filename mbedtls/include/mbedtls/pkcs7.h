...
#define MBEDTLS_ERR_PKCS7_FEATURE_UNAVAILABLE                                                                     \
    -0x5380                                       /**< Unavailable feature, e.g. anything other than signed data. \
                                                   */
#define MBEDTLS_ERR_PKCS7_INVALID_VERSION -0x5400 /**< The PKCS #7 version element is invalid or cannot be parsed. */
#define MBEDTLS_ERR_PKCS7_INVALID_CONTENT_INFO                                                                    \
    -0x5480                                         /**< The PKCS #7 content info is invalid or cannot be parsed. \
                                                     */

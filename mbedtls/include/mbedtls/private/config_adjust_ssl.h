...
#error \
    "Do not include mbedtls/config_adjust_*.h manually! This can lead to problems, " \
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_2) && \
    (defined(PSA_WANT_ALG_ECDH) || defined(PSA_WANT_ALG_ECDSA) || defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED))

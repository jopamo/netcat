 ...
 * \return                   \c 1 on success ("okay"), \c 0 on error.
 */
int psasim_server_deserialise_psa_hash_operation_t(uint8_t** pos, size_t* remaining, psa_hash_operation_t** value);
 ...
 * \return                   \c 1 on success ("okay"), \c 0 on error.
 */
int psasim_server_deserialise_psa_aead_operation_t(uint8_t** pos, size_t* remaining, psa_aead_operation_t** value);
 ...
 * \return                   \c 1 on success ("okay"), \c 0 on error.
 */
int psasim_server_deserialise_psa_mac_operation_t(uint8_t** pos, size_t* remaining, psa_mac_operation_t** value);
 ...
 * \return                   \c 1 on success ("okay"), \c 0 on error.
 */
int psasim_server_deserialise_psa_cipher_operation_t(uint8_t** pos, size_t* remaining, psa_cipher_operation_t** value);

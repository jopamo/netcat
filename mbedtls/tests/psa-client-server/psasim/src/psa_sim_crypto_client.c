...
#define CLIENT_PRINT(fmt, ...) INFO("Client: " fmt, ##__VA_ARGS__)
...
psa_status_t psa_aead_abort(psa_aead_operation_t* operation) {
    ...
    ok = psa_crypto_call(PSA_AEAD_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_decrypt(mbedtls_svc_key_id_t key,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_mbedtls_svc_key_id_t_needs(key) +
                    psasim_serialise_psa_algorithm_t_needs(alg) + psasim_serialise_buffer_needs(nonce, nonce_length) +
    ...
    ok = psa_crypto_call(PSA_AEAD_DECRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_decrypt_setup(psa_aead_operation_t* operation, mbedtls_svc_key_id_t key, psa_algorithm_t alg) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_aead_operation_t_needs(*operation) +
                    psasim_serialise_mbedtls_svc_key_id_t_needs(key) + psasim_serialise_psa_algorithm_t_needs(alg);
    ...
    ok = psa_crypto_call(PSA_AEAD_DECRYPT_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_encrypt(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_AEAD_ENCRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_encrypt_setup(psa_aead_operation_t* operation, mbedtls_svc_key_id_t key, psa_algorithm_t alg) {
    ...
    ok = psa_crypto_call(PSA_AEAD_ENCRYPT_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_finish(psa_aead_operation_t* operation,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_aead_operation_t_needs(*operation) +
                    psasim_serialise_buffer_needs(ciphertext, ciphertext_size) +
                    psasim_serialise_size_t_needs(*ciphertext_length) + psasim_serialise_buffer_needs(tag, tag_size) +
    ...
    ok = psa_crypto_call(PSA_AEAD_FINISH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_generate_nonce(psa_aead_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_AEAD_GENERATE_NONCE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_set_lengths(psa_aead_operation_t* operation, size_t ad_length, size_t plaintext_length) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_aead_operation_t_needs(*operation) +
                    psasim_serialise_size_t_needs(ad_length) + psasim_serialise_size_t_needs(plaintext_length);
    ...
    ok = psa_crypto_call(PSA_AEAD_SET_LENGTHS, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_set_nonce(psa_aead_operation_t* operation, const uint8_t* nonce, size_t nonce_length) {
    ...
    ok = psa_crypto_call(PSA_AEAD_SET_NONCE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_update(psa_aead_operation_t* operation,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_aead_operation_t_needs(*operation) +
                    ...
                    psasim_serialise_buffer_needs(output, output_size) + psasim_serialise_size_t_needs(*output_length);
    ...
    ok = psa_crypto_call(PSA_AEAD_UPDATE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_update_ad(psa_aead_operation_t* operation, const uint8_t* input, size_t input_length) {
    ...
    ok = psa_crypto_call(PSA_AEAD_UPDATE_AD, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_aead_verify(psa_aead_operation_t* operation,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_aead_operation_t_needs(*operation) +
                    psasim_serialise_buffer_needs(plaintext, plaintext_size) +
                    psasim_serialise_size_t_needs(*plaintext_length) + psasim_serialise_buffer_needs(tag, tag_length);
    ...
    ok = psa_crypto_call(PSA_AEAD_VERIFY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_asymmetric_decrypt(mbedtls_svc_key_id_t key,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_mbedtls_svc_key_id_t_needs(key) +
                    psasim_serialise_psa_algorithm_t_needs(alg) + psasim_serialise_buffer_needs(input, input_length) +
    ...
    ok = psa_crypto_call(PSA_ASYMMETRIC_DECRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_asymmetric_encrypt(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_ASYMMETRIC_ENCRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
int psa_can_do_hash(psa_algorithm_t hash_alg) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_algorithm_t_needs(hash_alg);
    ...
    ok = psasim_serialise_psa_algorithm_t(&pos, &remaining, hash_alg);
    if (!ok) {
        goto fail;
    }

    ok = psa_crypto_call(PSA_CAN_DO_HASH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
    ...
    ok = psasim_deserialise_int(&rpos, &rremain, &value);
    if (!ok) {
        goto fail;
    }
...
psa_status_t psa_cipher_abort(psa_cipher_operation_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_cipher_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_CIPHER_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_decrypt(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_CIPHER_DECRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_decrypt_setup(psa_cipher_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_CIPHER_DECRYPT_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_encrypt(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_CIPHER_ENCRYPT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_encrypt_setup(psa_cipher_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_CIPHER_ENCRYPT_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_finish(psa_cipher_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_CIPHER_FINISH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_generate_iv(psa_cipher_operation_t* operation, uint8_t* iv, size_t iv_size, size_t* iv_length) {
    ...
    ok = psa_crypto_call(PSA_CIPHER_GENERATE_IV, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_set_iv(psa_cipher_operation_t* operation, const uint8_t* iv, size_t iv_length) {
    ...
    ok = psa_crypto_call(PSA_CIPHER_SET_IV, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_cipher_update(psa_cipher_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_CIPHER_UPDATE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_copy_key(mbedtls_svc_key_id_t source_key,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_mbedtls_svc_key_id_t_needs(source_key) +
    ...
    ok = psa_crypto_call(PSA_COPY_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_destroy_key(mbedtls_svc_key_id_t key) {
    ...
    ok = psa_crypto_call(PSA_DESTROY_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_export_key(mbedtls_svc_key_id_t key, uint8_t* data, size_t data_size, size_t* data_length) {
    ...
    ok = psa_crypto_call(PSA_EXPORT_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_export_public_key(mbedtls_svc_key_id_t key, uint8_t* data, size_t data_size, size_t* data_length) {
    ...
    ok = psa_crypto_call(PSA_EXPORT_PUBLIC_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_export_public_key_iop_abort(psa_export_public_key_iop_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_export_public_key_iop_t_needs(*operation);
    ...
    ok = psasim_serialise_psa_export_public_key_iop_t(&pos, &remaining, *operation);
    if (!ok) {
        goto fail;
    }

    ok = psa_crypto_call(PSA_EXPORT_PUBLIC_KEY_IOP_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
    ...
    ok = psasim_deserialise_psa_export_public_key_iop_t(&rpos, &rremain, operation);
    if (!ok) {
        goto fail;
    }
...
psa_status_t psa_export_public_key_iop_complete(psa_export_public_key_iop_t* operation,
    ...
    ok = psa_crypto_call(PSA_EXPORT_PUBLIC_KEY_IOP_COMPLETE, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
uint32_t psa_export_public_key_iop_get_num_ops(psa_export_public_key_iop_t* operation) {
    ...
    ok = psa_crypto_call(PSA_EXPORT_PUBLIC_KEY_IOP_GET_NUM_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_export_public_key_iop_setup(psa_export_public_key_iop_t* operation, mbedtls_svc_key_id_t key) {
    ...
    ok = psa_crypto_call(PSA_EXPORT_PUBLIC_KEY_IOP_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_generate_key(const psa_key_attributes_t* attributes, mbedtls_svc_key_id_t* key) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_key_attributes_t_needs(*attributes) +
                    psasim_serialise_mbedtls_svc_key_id_t_needs(*key);
    ...
    ok = psa_crypto_call(PSA_GENERATE_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_generate_key_custom(const psa_key_attributes_t* attributes,
    ...
    ok = psasim_serialise_psa_custom_key_parameters_t(&pos, &remaining, *custom);
    if (!ok) {
        goto fail;
    }
    ok = psasim_serialise_buffer(&pos, &remaining, custom_data, custom_data_length);
    if (!ok) {
        goto fail;
    }
    ok = psasim_serialise_mbedtls_svc_key_id_t(&pos, &remaining, *key);
    ...
    ok = psa_crypto_call(PSA_GENERATE_KEY_CUSTOM, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_generate_key_iop_abort(psa_generate_key_iop_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_generate_key_iop_t_needs(*operation);
    ...
    ok = psasim_serialise_psa_generate_key_iop_t(&pos, &remaining, *operation);
    if (!ok) {
        goto fail;
    }

    ok = psa_crypto_call(PSA_GENERATE_KEY_IOP_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
    ...
    ok = psasim_deserialise_psa_generate_key_iop_t(&rpos, &rremain, operation);
    if (!ok) {
        goto fail;
    }
...
psa_status_t psa_generate_key_iop_complete(psa_generate_key_iop_t* operation, mbedtls_svc_key_id_t* key) {
    ...
    ok = psa_crypto_call(PSA_GENERATE_KEY_IOP_COMPLETE, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
uint32_t psa_generate_key_iop_get_num_ops(psa_generate_key_iop_t* operation) {
    ...
    ok = psa_crypto_call(PSA_GENERATE_KEY_IOP_GET_NUM_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_generate_key_iop_setup(psa_generate_key_iop_t* operation, const psa_key_attributes_t* attributes) {
    ...
    ok = psa_crypto_call(PSA_GENERATE_KEY_IOP_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_generate_random(uint8_t* output, size_t output_size) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_buffer_needs(output, output_size);
    ...
    ok = psa_crypto_call(PSA_GENERATE_RANDOM, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_get_key_attributes(mbedtls_svc_key_id_t key, psa_key_attributes_t* attributes) {
    ...
    ok = psa_crypto_call(PSA_GET_KEY_ATTRIBUTES, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_abort(psa_hash_operation_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_hash_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_HASH_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_clone(const psa_hash_operation_t* source_operation, psa_hash_operation_t* target_operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_hash_operation_t_needs(*source_operation) +
    ...
    ok = psa_crypto_call(PSA_HASH_CLONE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_compare(psa_algorithm_t alg,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_algorithm_t_needs(alg) +
                    psasim_serialise_buffer_needs(input, input_length) +
    ...
    ok = psa_crypto_call(PSA_HASH_COMPARE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_compute(psa_algorithm_t alg,
    ...
    ok = psa_crypto_call(PSA_HASH_COMPUTE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_finish(psa_hash_operation_t* operation, uint8_t* hash, size_t hash_size, size_t* hash_length) {
    ...
    ok = psa_crypto_call(PSA_HASH_FINISH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_setup(psa_hash_operation_t* operation, psa_algorithm_t alg) {
    ...
    ok = psa_crypto_call(PSA_HASH_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_update(psa_hash_operation_t* operation, const uint8_t* input, size_t input_length) {
    ...
    ok = psa_crypto_call(PSA_HASH_UPDATE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_hash_verify(psa_hash_operation_t* operation, const uint8_t* hash, size_t hash_length) {
    ...
    ok = psa_crypto_call(PSA_HASH_VERIFY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_import_key(const psa_key_attributes_t* attributes,
    ...
    ok = psa_crypto_call(PSA_IMPORT_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
uint32_t psa_interruptible_get_max_ops(void) {
    ...
    size_t needed = psasim_serialise_begin_needs() + 0;
    ...
    ok = psa_crypto_call(PSA_INTERRUPTIBLE_GET_MAX_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
void psa_interruptible_set_max_ops(uint32_t max_ops) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_uint32_t_needs(max_ops);
    ...
    ok = psa_crypto_call(PSA_INTERRUPTIBLE_SET_MAX_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_agreement(mbedtls_svc_key_id_t private_key,
    ...
    size_t needed =
        psasim_serialise_begin_needs() + psasim_serialise_mbedtls_svc_key_id_t_needs(private_key) +
        psasim_serialise_buffer_needs(peer_key, peer_key_length) + psasim_serialise_psa_algorithm_t_needs(alg) +
        psasim_serialise_psa_key_attributes_t_needs(*attributes) + psasim_serialise_mbedtls_svc_key_id_t_needs(*key);
    ...
    ok = psa_crypto_call(PSA_KEY_AGREEMENT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_key_agreement_iop_abort(psa_key_agreement_iop_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_key_agreement_iop_t_needs(*operation);
    ...
    ok = psasim_serialise_psa_key_agreement_iop_t(&pos, &remaining, *operation);
    if (!ok) {
        goto fail;
    }

    ok = psa_crypto_call(PSA_KEY_AGREEMENT_IOP_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
    ...
    ok = psasim_deserialise_psa_key_agreement_iop_t(&rpos, &rremain, operation);
    if (!ok) {
        goto fail;
    }
...
psa_status_t psa_key_agreement_iop_complete(psa_key_agreement_iop_t* operation, mbedtls_svc_key_id_t* key) {
    ...
    ok = psa_crypto_call(PSA_KEY_AGREEMENT_IOP_COMPLETE, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
uint32_t psa_key_agreement_iop_get_num_ops(psa_key_agreement_iop_t* operation) {
    ...
    ok = psa_crypto_call(PSA_KEY_AGREEMENT_IOP_GET_NUM_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_agreement_iop_setup(psa_key_agreement_iop_t* operation,
    ...
    ok = psa_crypto_call(PSA_KEY_AGREEMENT_IOP_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_abort(psa_key_derivation_operation_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_key_derivation_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_get_capacity(const psa_key_derivation_operation_t* operation, size_t* capacity) {
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_GET_CAPACITY, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_input_bytes(psa_key_derivation_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_INPUT_BYTES, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_input_integer(psa_key_derivation_operation_t* operation,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_key_derivation_operation_t_needs(*operation) +
                    psasim_serialise_psa_key_derivation_step_t_needs(step) + psasim_serialise_uint64_t_needs(value);
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_INPUT_INTEGER, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_input_key(psa_key_derivation_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_INPUT_KEY, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_key_agreement(psa_key_derivation_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_KEY_AGREEMENT, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_output_bytes(psa_key_derivation_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_OUTPUT_BYTES, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_output_key(const psa_key_attributes_t* attributes,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_OUTPUT_KEY, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_output_key_custom(const psa_key_attributes_t* attributes,
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_OUTPUT_KEY_CUSTOM, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_set_capacity(psa_key_derivation_operation_t* operation, size_t capacity) {
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_SET_CAPACITY, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_key_derivation_setup(psa_key_derivation_operation_t* operation, psa_algorithm_t alg) {
    ...
    ok = psa_crypto_call(PSA_KEY_DERIVATION_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_abort(psa_mac_operation_t* operation) {
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_psa_mac_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_MAC_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_compute(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_MAC_COMPUTE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_sign_finish(psa_mac_operation_t* operation, uint8_t* mac, size_t mac_size, size_t* mac_length) {
    ...
    ok = psa_crypto_call(PSA_MAC_SIGN_FINISH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_sign_setup(psa_mac_operation_t* operation, mbedtls_svc_key_id_t key, psa_algorithm_t alg) {
    ...
    ok = psa_crypto_call(PSA_MAC_SIGN_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_update(psa_mac_operation_t* operation, const uint8_t* input, size_t input_length) {
    ...
    ok = psa_crypto_call(PSA_MAC_UPDATE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_verify(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_MAC_VERIFY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_verify_finish(psa_mac_operation_t* operation, const uint8_t* mac, size_t mac_length) {
    ...
    ok = psa_crypto_call(PSA_MAC_VERIFY_FINISH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_mac_verify_setup(psa_mac_operation_t* operation, mbedtls_svc_key_id_t key, psa_algorithm_t alg) {
    ...
    ok = psa_crypto_call(PSA_MAC_VERIFY_SETUP, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_purge_key(mbedtls_svc_key_id_t key) {
    ...
    ok = psa_crypto_call(PSA_PURGE_KEY, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_raw_key_agreement(psa_algorithm_t alg,
    ...
    ok = psa_crypto_call(PSA_RAW_KEY_AGREEMENT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
void psa_reset_key_attributes(psa_key_attributes_t* attributes) {
    ...
    ok = psa_crypto_call(PSA_RESET_KEY_ATTRIBUTES, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_sign_hash(mbedtls_svc_key_id_t key,
    ...
    size_t needed = psasim_serialise_begin_needs() + psasim_serialise_mbedtls_svc_key_id_t_needs(key) +
                    psasim_serialise_psa_algorithm_t_needs(alg) + psasim_serialise_buffer_needs(hash, hash_length) +
    ...
    ok = psa_crypto_call(PSA_SIGN_HASH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_sign_hash_abort(psa_sign_hash_interruptible_operation_t* operation) {
    ...
    size_t needed =
        psasim_serialise_begin_needs() + psasim_serialise_psa_sign_hash_interruptible_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_SIGN_HASH_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_sign_hash_complete(psa_sign_hash_interruptible_operation_t* operation,
    ...
    size_t needed =
        psasim_serialise_begin_needs() + psasim_serialise_psa_sign_hash_interruptible_operation_t_needs(*operation) +
        psasim_serialise_buffer_needs(signature, signature_size) + psasim_serialise_size_t_needs(*signature_length);
    ...
    ok = psa_crypto_call(PSA_SIGN_HASH_COMPLETE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
uint32_t psa_sign_hash_get_num_ops(const psa_sign_hash_interruptible_operation_t* operation) {
    ...
    ok =
        psa_crypto_call(PSA_SIGN_HASH_GET_NUM_OPS, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_sign_hash_start(psa_sign_hash_interruptible_operation_t* operation,
    ...
    ok = psa_crypto_call(PSA_SIGN_HASH_START, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_sign_message(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_SIGN_MESSAGE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_verify_hash(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_VERIFY_HASH, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_verify_hash_abort(psa_verify_hash_interruptible_operation_t* operation) {
    ...
    size_t needed =
        psasim_serialise_begin_needs() + psasim_serialise_psa_verify_hash_interruptible_operation_t_needs(*operation);
    ...
    ok = psa_crypto_call(PSA_VERIFY_HASH_ABORT, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_verify_hash_complete(psa_verify_hash_interruptible_operation_t* operation) {
    ...
    ok = psa_crypto_call(PSA_VERIFY_HASH_COMPLETE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
uint32_t psa_verify_hash_get_num_ops(const psa_verify_hash_interruptible_operation_t* operation) {
    ...
    ok = psa_crypto_call(PSA_VERIFY_HASH_GET_NUM_OPS, ser_params, (size_t)(pos - ser_params), &ser_result,
                         &result_length);
    if (!ok) {
...
psa_status_t psa_verify_hash_start(psa_verify_hash_interruptible_operation_t* operation,
    ...
    size_t needed =
        psasim_serialise_begin_needs() + psasim_serialise_psa_verify_hash_interruptible_operation_t_needs(*operation) +
        psasim_serialise_mbedtls_svc_key_id_t_needs(key) + psasim_serialise_psa_algorithm_t_needs(alg) +
        psasim_serialise_buffer_needs(hash, hash_length) + psasim_serialise_buffer_needs(signature, signature_length);
    ...
    ok = psa_crypto_call(PSA_VERIFY_HASH_START, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {
...
psa_status_t psa_verify_message(mbedtls_svc_key_id_t key,
    ...
    ok = psa_crypto_call(PSA_VERIFY_MESSAGE, ser_params, (size_t)(pos - ser_params), &ser_result, &result_length);
    if (!ok) {

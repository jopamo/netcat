...
#if !defined(MBEDTLS_NET_C) || !defined(MBEDTLS_SSL_SRV_C) || !defined(MBEDTLS_TIMING_C) ||                \
    !defined(MBEDTLS_SSL_PROTO_DTLS) || !defined(MBEDTLS_SSL_COOKIE_C) || !defined(MBEDTLS_PEM_PARSE_C) || \

...
#if !defined(MBEDTLS_BIGNUM_C) || !defined(MBEDTLS_SSL_TLS_C) || !defined(MBEDTLS_SSL_CLI_C) || \
    !defined(MBEDTLS_NET_C) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || \
    !defined(MBEDTLS_FS_IO) || defined(MBEDTLS_X509_REMOVE_INFO)
int main(void) {
    mbedtls_printf(

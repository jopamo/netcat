...
#define TEST_EQUAL(expr1, expr2)                                                                       \
    do {                                                                                               \
        if (!mbedtls_test_equal(#expr1 " == " #expr2, __LINE__, __FILE__, (unsigned long long)(expr1), \
                                (unsigned long long)(expr2)))                                          \
            goto exit;                                                                                 \
    } while (0)
...
#define TEST_LE_U(expr1, expr2)                                                         \
    do {                                                                                \
        if (!mbedtls_test_le_u(#expr1 " <= " #expr2, __LINE__, __FILE__, expr1, expr2)) \
            goto exit;                                                                  \
    } while (0)
...
#define TEST_LE_S(expr1, expr2)                                                         \
    do {                                                                                \
        if (!mbedtls_test_le_s(#expr1 " <= " #expr2, __LINE__, __FILE__, expr1, expr2)) \
            goto exit;                                                                  \
    } while (0)
...
#define TEST_CALLOC(pointer, item_count)                                  \
    do {                                                                  \
        ...
        if ((item_count) != 0) {                                          \
            (pointer) = mbedtls_calloc((item_count), sizeof(*(pointer))); \
            TEST_ASSERT((pointer) != NULL);                               \
        }                                                                 \
    } while (0)
